...
class Sample(object):
    ...
    def __sub__(self, other):
        ...
        res = []
        for i in range(self.dimensionality()):
            res.append(self.getFeatures()[i] - other.getFeatures()[i])
        return Sample(self.name + '-',res,self.label)
    ...
    def power(self, x):
        ...
        res = []
        for i in range(self.dimensionality()):
            res.append(self.getFeatures()[i]**x)
        return Sample(self.name + '-power(' + str(x) + ')', res, self.label)
